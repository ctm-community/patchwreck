...
execute as @s[scores={endscape.curse=50}] run playsound minecraft:entity.ender_dragon.flap hostile @s ~ ~ ~ 1 1
execute as @s[scores={endscape.curse=100}] run playsound minecraft:entity.ender_dragon.flap hostile @s ~ ~ ~ 1 1
execute as @s[scores={endscape.curse=150}] run playsound minecraft:entity.ender_dragon.flap hostile @s ~ ~ ~ 1 1
...
execute as @s[scores={endscape.curse=200}] run playsound minecraft:entity.ender_dragon.growl hostile @s ~ ~ ~ 1 1
