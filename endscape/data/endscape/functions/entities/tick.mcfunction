...
execute as @e[team=ender_cultist] run function endscape:entities/ender_lich/tick
execute as @e[type=minecraft:end_crystal] at @s if entity @s[y=-72,dy=-32] run kill @s
